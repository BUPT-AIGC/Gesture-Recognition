...
// })
// // 设置静态文件目录
// app.use(express.static(path.join(__dirname, 'Gesture-Recognition/hand-landmark-detection')));
// 处理根路径请求，返回 index.html
app.get('/', function(req, res) {
  res.sendFile('C:/Users/Tony/Desktop/HongMeng/Gesture-Recognition/hand-landmark-detection/index.html');
});
